...
-- Adicionando comentários da tabela e atributos
...
-- Definindo a chave única da tabela DEPARTAMENTO
...
-- Definindo a chave única da tabela PROJETO
...
-- Criando a Fk de cpf_gerente (tabela departamento) ligada a Pk cpf (tabela funcionário)
...
-- Criando a Fk de cpf_funcionario (tabela trabalha_em) ligada a Pk cpf (tabela funcionário)
...
-- Criando a Fk de cpf_funcionario (tabela dependente) ligada a Pk cpf (tabela funcionário)
...
-- Criando a Fk de cpf_funcionario (tabela funcionario) ligada a Pk cpf (tabela funcionário)
...
-- Criando a Fk de cpf_funcionario (tabela localizacoes_departamento) ligada a Pk cpf (tabela departamento)
...
-- Criando a Fk de numero_departamento (tabela projeto) ligada a Pk numero_departamento (tabela departamento)
...
-- Criando a Fk de numero_projeto (tabela trabalha_em) ligada a Pk numero_projeto (tabela projeto)
